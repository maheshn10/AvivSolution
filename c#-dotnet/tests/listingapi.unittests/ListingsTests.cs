...
namespace listingapi.unittests
{
    public class ListingsTests
    {
        ...
        public ListingsTests()
        {
            ...
            //var AppContextMock = new Mock<AppDbContext>(options);
            //AppContextMock.Setup(m => m.Listings).Returns(new Mock<DbSet<Infrastructure.Database.Models.Listing>>().Object);
            var unitOfWorkMock = new Mock<IUnitOfWork>();
            //unitOfWorkMock.Setup(m => m.ListingRepository.InsertAsync()).Returns();
            //unitOfWorkMock.Setup(m => m.Listings).Returns(new Mock<DbSet<Infrastructure.Database.Models.Listing>>().Object);
            var mockMapper = new Mock<IMapper>();

            _listingsController = new ListingsController(loggerMock.Object, unitOfWorkMock.Object, mockMapper.Object);
