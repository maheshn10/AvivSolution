...
namespace listingapi.Controllers
{
    ...
    public class ListingsController : ControllerBase
    {
        ...
        public ListingsController(ILogger<ListingsController> logger, IUnitOfWork unitOfWork, IMapper mapper)
        {
            _logger = logger;
        ...
        public IActionResult GetListingsAsync()
        {
            try
            {
                ...
                var listings = _unitOfWork.ListingRepository.GetAll;
                results = _mapper.Map<List<ListingReadOnly>>(listings);
        ...
        public async Task<IActionResult> PostListingAsync([FromBody] Listing listing, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _unitOfWork.ListingRepository.InsertAsync(result);
                await _unitOfWork.AsyncSave();
        ...
        public async Task<IActionResult> PutListingAsync(int id, [FromBody] Listing listing, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var result = await _unitOfWork.ListingRepository.GetAsyncById(id);
                ...
                _unitOfWork.ListingRepository.Update(result);
                await _unitOfWork.AsyncSave();
                return Ok(_mapper.Map<ListingReadOnly>(result));
